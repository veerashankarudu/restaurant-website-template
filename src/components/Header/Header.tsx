    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`lg:hidden transition-all duration-300 overflow-hidden ${
          ...
          <div className="py-4 space-y-4 bg-white bg-opacity-95 backdrop-blur-md rounded-lg mt-2 px-4">
            <button
              onClick={() => scrollToSection('home')}
              className="block w-full text-left font-medium text-gray-700 hover:text-primary-500 py-2"
            >
              Home
            </button>
            <button
